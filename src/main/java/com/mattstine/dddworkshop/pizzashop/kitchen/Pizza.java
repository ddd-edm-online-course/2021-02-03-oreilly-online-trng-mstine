    ...
    private static class Accumulator implements BiFunction<Pizza, PizzaEvent, Pizza> {
        ...
        public Pizza apply(Pizza pizza, PizzaEvent pizzaEvent) {
            if (pizzaEvent instanceof PizzaAddedEvent) {
                PizzaAddedEvent pizzaAddedEvent = (PizzaAddedEvent) pizzaEvent;
                return Pizza.builder()
                        .ref(pizzaAddedEvent.getRef())
                        .kitchenOrderRef(pizzaAddedEvent.getState().getKitchenOrderRef())
                        .size(pizzaAddedEvent.getState().getSize())
